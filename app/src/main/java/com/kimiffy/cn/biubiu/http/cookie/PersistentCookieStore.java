...
/**
 * Description:cookie 本地存贮
 * Created by kimiffy on 2019/5/10.
 */

public class PersistentCookieStore {
    private static final String LOG_TAG = "PersistentCookieStore";
    private static final String PREFS_COOKIES = "Prefs_Cookies";
    private final Map<String, ConcurrentMap<String, Cookie>> cookies;
    private final SharedPreferences cookiePrefs;

    public PersistentCookieStore() {
        cookiePrefs = MyApplication.getInstance().getSharedPreferences(PREFS_COOKIES, 0);
        cookies = new HashMap<>();
